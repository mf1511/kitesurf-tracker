...
const CAT = {
  ...
  HANDLEPASS: "Figures avancées",
  WAVE: "Wave riding / strapless",
  FOIL: "Kitefoil",
  EXTREME: "Figures avancées",
};
...
const figures: FigureSeed[] = [
  ...
  f("toe-side-riding", "Toe-side riding", CAT.BASES,
    "Module « Riding » — Naviguer orteils vers l'avant — base du wave et des toeside tricks.",
  ...
  f("toe-side-turn", "Toe-side turn", CAT.BASES,
    "Module « Transitions » — Changer de bord en passant par le toe-side (IKO Level 3).",
  ...
  f("power-jibe", "Power jibe", CAT.BASES,
    "Module « Transitions » — Transition dynamique avec kite en traction — base du darkslide et des transitions avancées.",
  ...
  f("transition-180", "Transition 180° (switch)", CAT.BASES,
    "Module « Transitions » — Léger saut avec rotation 180° pour repartir en switch.",
  ...
  f("jump-transition", "Jump transition", CAT.BASES,
    "Module « Transitions » — Transition avec vrai saut (IKO Level 4) — change de sens en l'air.",
  ...
  f("riding-switch", "Riding switch", CAT.BASES,
    "Module « Riding » — Naviguer longtemps en stance inversée de façon stable.",
  ...
  f("bidirectionnel-fluide", "Bidirectionnel fluide", CAT.BASES,
    "Module « Riding » — Naviguer aussi bien dans les deux sens sans perte de vitesse.",
  ...
  f("unhooked-riding", "Unhooked riding", CAT.BASES,
    "Module « Riding » — Naviguer décroché du chicken loop — prérequis de tout le freestyle wakestyle.",
  ...
  f("hand-drag-basique", "Hand drag", CAT.SURFACE,
    "Module « Drags » — Lâcher une main et traîner la main dans l'eau en pleine glisse.",
  ...
  f("hand-drag-transition", "Hand drag transition", CAT.SURFACE,
    "Module « Drags » — Hand drag enchaîné directement avec une transition de bord.",
  ...
  f("hand-drag-backroll", "Hand drag backroll", CAT.SURFACE,
    "Module « Drags » — Hand drag suivi d'un backroll au redressement.",
  ...
  f("surface-backroll-transition", "Surface Backroll Transition", CAT.SURFACE,
    "Module « Blind » — Backroll bas / plat utilisé comme transition de bord, proche de l'eau (sans gros boost).",
    [
  ...
  f("surface-backroll-360", "Surface Backroll 360", CAT.SURFACE,
    "Module « Blind » — Backroll 360° plat / bas, proche de l'eau — rotation complète sans gros airtime.",
    [
  ...
  f("foot-drag", "Foot drag", CAT.SURFACE,
    "Module « Drags » — Retirer un pied du strap et le traîner dans l'eau.",
  ...
  f("tootsie-roll-surface", "Tootsie roll (surface)", CAT.SURFACE,
    "Module « Slides » — Foot drag stylé avec rotation / slide — classic old-school surface.",
  ...
  f("grab-drag", "Grab drag", CAT.SURFACE,
    "Module « Drags » — Grab de board en glisse avec une main dans l'eau ou près de la surface.",
  ...
  f("one-foot-slide", "1-foot slide", CAT.SURFACE,
    "Module « Slides » — Glisser sur un pied, l'autre sorti — progression vers barefoot / jesus.",
  ...
  f("barefoot-slide", "Barefoot slide", CAT.SURFACE,
    "Module « Slides » — Glisser sans les deux pieds dans les straps, board sous contrôle.",
  ...
  f("jesus-walk", "Jesus walk", CAT.SURFACE,
    "Module « Slides » — Marcher / glisser sur l'eau pieds nus tracté par le kite (style).",
    ["Barefoot slide stable", "Se redresser progressivement", "Petits pas / glissades contrôlés"],
    ["barefoot-slide"]
  ),
  f("riding-blind", "Riding blind", CAT.SURFACE,
    "Module « Blind » — Naviguer dos au kite / regard opposé — base des réceptions blind.",
  ...
  f("blind-to-toeside-transition", "Blind to Toeside Transition", CAT.SURFACE,
    "Module « Blind » — Depuis le riding blind, pivoter pour repartir en toeside (transition de bord).",
    [
  ...
  f("darkslide", "Darkslide", CAT.SURFACE,
    "Module « Darkslide » — Glisser sur le dessus (dark side) de la board, tip dans l'eau, sortie souvent en kiteloop.",
  ...
  f("darkslide-backroll-out", "Darkslide backroll out", CAT.SURFACE,
    "Module « Darkslide » — Darkslide terminé par un backroll au lieu d'un simple kiteloop.",
  ...
  f("surface-pass", "Surface pass", CAT.SURFACE,
    "Module « Blind » — Passage de barre au niveau de l'eau (raley surface / flat pass prep).",
  ...
  f("one-foot-air", "One-foot air (judo air)", CAT.OLDSCHOOL,
    "Module « Old school » — Sortir un pied en l'air et le remettre avant la réception.",
  ...
  f("board-off", "Board off", CAT.OLDSCHOOL,
    "Module « Board-offs » — Retirer les deux pieds, tenir la board, et la remettre en l'air.",
  ...
  f("stiffy", "Stiffy", CAT.OLDSCHOOL,
    "Module « Old school » — Saut jambes tendues / board figée — style old-school.",
  ...
  f("down-loop", "Downloop", CAT.KITELOOP,
    "Module « Bases » — Loop du kite vers le bas / devant le rider (moins violent qu'un kiteloop back).",
  ...
  f("down-loop-transition", "Downloop transition", CAT.KITELOOP,
    "Module « Bases » — Transition de bord en downloopant le kite.",
  ...
  f("kite-loop-simple", "Kiteloop", CAT.KITELOOP,
    "Module « Bases » — Loop complet du kite en bord de fenêtre — figure reine du big air.",
  ...
  f("heli-loop", "Heli loop (landing)", CAT.KITELOOP,
    "Module « Bases » — Petit loop / helix pour amortir et contrôler la réception.",
  ...
  f("kite-loop-pendant-saut", "Late kiteloop", CAT.KITELOOP,
    "Module « En saut » — Kiteloop déclenché tardivement (après l'apogée) — classic big air.",
  ...
  f("backroll-kite-loop", "Backroll kiteloop", CAT.KITELOOP,
    "Module « En saut » — Backroll combiné à un kiteloop.",
  ...
  f("frontroll-kite-loop", "Frontroll kiteloop", CAT.KITELOOP,
    "Module « En saut » — Frontroll combiné à un kiteloop.",
  ...
  f("megaloop", "Megaloop", CAT.KITELOOP,
    "Module « Big air » — Kiteloop massif en vent fort, chute verticale rapide — signature KOTA.",
  ...
  f("double-kite-loop", "Double kiteloop", CAT.KITELOOP,
    "Module « Big air » — Deux loops consécutifs du kite en l'air (Giel Vlugt / KOTA).",
  ...
  f("triple-kite-loop", "Triple kiteloop", CAT.KITELOOP,
    "Module « Big air » — Trois loops kite — ultra extrême.",
    ["Double loop solide", "Enchaîner le 3e loop", "Réception ultra engagée"],
    ["double-kite-loop"]
  ),
  f("s-loop", "S-loop", CAT.KITELOOP,
    "Module « Big air » — Demi-megalooop puis inversion du sens du kite (forme en S).",
  ...
  f("contra-loop", "Contra loop", CAT.KITELOOP,
    "Module « Big air » — Loop du kite dans le sens opposé au sens habituel — freefall plus agressif.",
    ["Boost", "Looper à contre-sens", "Absorber le freefall"],
    ["kite-loop-simple"]
  ),
  f("boogie-loop", "Boogie loop", CAT.KITELOOP,
    "Module « Big air » — Kiteloop avec inverted frontroll — classic big air technique.",
  ...
  f("doobie-loop", "Doobie loop", CAT.KITELOOP,
    "Module « Big air » — Boogie loop avec double inverted frontroll.",
  ...
  f("slider-loop", "Slider loop", CAT.KITELOOP,
    "Module « Big air » — Loop combiné à un slide / surface approach.",
  ...
  f("kite-loop-board-off", "Kiteloop board off", CAT.KITELOOP,
    "Module « Combos » — Kiteloop / megaloop avec board tenue à la main (Nick Jacobsen era).",
  ...
  f("unhooked-kite-loop", "Unhooked kiteloop", CAT.KITELOOP,
    "Module « Combos » — Kiteloop réalisé décroché — pont vers le freestyle powered.",
  ...
  f("raley-kite-loop", "Raley kiteloop", CAT.KITELOOP,
    "Module « Combos » — Position raley + kiteloop (souvent unhooked).",
  ...
  f("loop-transition-unhooked", "Loop transition unhooked", CAT.KITELOOP,
    "Module « Combos » — Transition de bord via kiteloop / downloop en unhooked.",
  ...
  f("f16", "F-16", CAT.KITELOOP,
    "Module « Big air » — Kiteloop backroll unhooked — nom AKA / old freestyle.",
  ...
  f("chicken-loop-unhook-air", "Unhook / rehook en l'air", CAT.UNHOOKED,
    "Module « Setup » — Décrocher et se rehooker pendant un saut — compétence freestyle clé.",
  ...
  f("raley-front", "Raley", CAT.UNHOOKED,
    "Module « Raleys » — Extension horizontale, board au-dessus de la tête — base du freestyle unhooked.",
  ...
  f("raley-back", "Back raley / wrapped setup", CAT.UNHOOKED,
    "Module « Raleys » — Raley engagé côté back / préparation wrapped.",
    ["Pop raley avec rotation légère back", "Extension complète", "Réception contrôlée"],
    ["raley-front"]
  ),
  f("raley-to-blind", "Raley to blind", CAT.UNHOOKED,
    "Module « Raleys » — Raley suivi d'un demi-tour pour atterrir blind / toeside.",
  ...
  f("wrapped-raley", "Wrapped raley", CAT.UNHOOKED,
    "Module « Raleys » — Raley avec lines wrappées (une rotation de wrap) — setup de wrapped tricks.",
  ...
  f("back-to-blind", "Back to blind", CAT.UNHOOKED,
    "Module « Blind » — Sortie backside vers réception blind — lié à la famille KGB.",
    ["Backroll / KGB setup", "Atterrir blind", "Stabiliser"],
    ["kgb", "riding-blind"]
  ),
  // ========== HANDLE PASSES & MOBES ==========
  f("flat-180-pass", "Flat 180 pass", CAT.HANDLEPASS,
    "Module « Passes de base » — Premier handle pass : demi-tour avec passage de barre près de l'eau / flat.",
  ...
  f("handle-pass-btf", "Handle pass back-to-front", CAT.HANDLEPASS,
    "Module « Passes de base » — Passage de barre main arrière → main avant.",
    ["Rotation opposée au FTB", "Pass clean back to front", "Réception"],
    ["handle-pass-ftb"]
  ),
  f("three-one-three", "313", CAT.HANDLEPASS,
    "Module « 3xx » — Raley + handle pass frontside 360 — LA base des air passes (Shaun Murray).",
  ...
  f("three-one-five", "315", CAT.HANDLEPASS,
    "Module « 3xx » — 313 + 180° = 540° de rotation totale.",
  ...
  f("munchies", "Munchies", CAT.HANDLEPASS,
    "Module « Avancé » — Trick unhooked nommé (grab + pass spécifique).",
    ["Setup unhooked", "Grab + pass munchies", "Réception"],
    ["krypto", "grab-indy"]
  ),
  f("nis", "NIS", CAT.HANDLEPASS,
    "Module « Avancé » — Handle pass nommé de la liste freestyle (GSKV / comps).",
    ["Pass avancé NIS", "Rotation synchronisée", "Réception"],
    ["back-mobe", "front-mobe"]
  ),
  f("s-bend-pass", "S-bend pass", CAT.HANDLEPASS,
    "Module « Avancé » — S-bend avec handle pass (sans forcément être un S-mobe complet).",
    ["S-bend", "Intégrer un pass", "Réception"],
    ["s-bend-unhooked", "handle-pass-ftb"]
  ),
  f("kiteloop-3", "Kiteloop 3 (kiteloop pass)", CAT.KITELOOP,
    "Module « Combos » — Kiteloop + handle pass 360°.",
    ["Unhooked kiteloop", "Pass 360 pendant le loop", "Réception"],
    ["unhooked-kite-loop", "three-one-three"]
  ),

  // ========== SAUTS — toeside (rolls / raleys / passes) ==========
  f("toeside-backroll", "Toeside backroll", CAT.BIGAIR,
    "Module « Backroll » — Backroll déclenché depuis le toeside.",
    ["Riding toeside stable", "Pop et backroll", "Réception"],
    ["toe-side-riding", "backroll-simple"]
  ),
  f("toeside-frontroll", "Toeside frontroll", CAT.BIGAIR,
    "Module « Frontroll » — Frontroll depuis le toeside.",
    ["Toeside", "Frontroll", "Réception"],
    ["toe-side-riding", "frontroll-simple"]
  ),
  f("toeside-backroll-5", "Toeside backroll 5", CAT.BIGAIR,
    "Module « Backroll » — Toeside backroll +180°.",
    ["Toeside backroll", "Prolonger", "Réception"],
    ["toeside-backroll"]
  ),
  f("toeside-frontroll-5", "Toeside frontroll 5", CAT.BIGAIR,
    "Module « Frontroll » — Toeside frontroll +180°.",
    ["Toeside frontroll", "Prolonger", "Réception"],
    ["toeside-frontroll"]
  ),
  f("scarecrow", "Scarecrow", CAT.BIGAIR,
    "Module « Passes » — Toeside frontroll + frontside 180.",
    ["Toeside frontroll", "Ajouter FS 180", "Réception"],
    ["toeside-frontroll"]
  ),
  f("crow-mobe", "Crow mobe", CAT.BIGAIR,
    "Module « Passes » — Toeside frontroll + frontside 360 pass (Parks Bonifay).",
    ["Scarecrow / toeside frontroll", "Pass FS 360", "Réception"],
    ["scarecrow", "front-mobe"]
  ),
  f("crow-mobe-5", "Crow mobe 5 (540)", CAT.BIGAIR,
    "Module « Passes » — Crow mobe +180°.",
    ["Crow mobe", "Prolonger", "Réception"],
    ["crow-mobe"]
  ),
  f("crow-mobe-7", "Crow mobe 7 (720)", CAT.BIGAIR,
    "Module « Passes » — Crow mobe 720°.",
    ["Crow mobe 5", "Commit", "Réception"],
    ["crow-mobe-5"]
  ),
  f("crow-mobe-9", "Crow mobe 9 (900)", CAT.BIGAIR,
    "Module « Passes » — Crow mobe 900°.",
    ["Crow mobe 7", "Max", "Réception"],
    ["crow-mobe-7"]
  ),
  f("fruit-loop", "Fruit loop", CAT.BIGAIR,
    "Module « Avancé » — Toeside frontflip + backside 180.",
    ["Toeside", "Frontflip / invert", "BS 180 et réception"],
    ["toeside-frontroll", "inverted-frontroll"]
  ),
  f("flavor-flip", "Flavor flip", CAT.BIGAIR,
    "Module « Avancé » — Variante toeside front flip (liste PKRA).",
    ["Fruit loop / front flip toeside", "Tweak flavor", "Réception"],
    ["fruit-loop"]
  ),
  f("nine-o-two-one-o", "90210", CAT.BIGAIR,
    "Module « Avancé » — Toeside raley + frontside 360 pass.",
    ["Toeside raley", "Pass FS 360", "Réception"],
    ["raley-front", "toe-side-riding", "three-one-three"]
  ),
  f("oh-really", "90215 / Oh Really", CAT.BIGAIR,
    "Module « Avancé » — Évolution du 90210 (liste officielle).",
    ["90210", "Prolonger la rotation / pass", "Réception"],
    ["nine-o-two-one-o"]
  ),
  f("toeside-r2b", "Toeside raley to blind", CAT.BIGAIR,
    "Module « Raleys » — Raley toeside atterrissant blind.",
    ["Raley toeside", "Orienter blind", "Stabiliser"],
    ["raley-to-blind", "toe-side-riding"]
  ),
  f("toeside-backside-313", "Toeside backside 313", CAT.BIGAIR,
    "Module « Passes » — 313 toeside backside.",
    ["Toeside setup", "Pass type 313 backside", "Réception"],
    ["three-one-three", "toeside-r2b"]
  ),
  f("toeside-backside-315", "Toeside backside 315", CAT.BIGAIR,
    "Module « Passes » — Toeside BS 313 +180°.",
    ["Toeside BS 313", "Prolonger", "Réception"],
    ["toeside-backside-313"]
  ),
  f("c7", "C7", CAT.BIGAIR,
    "Module « Passes » — Toeside advanced S-bend family (liste PKRA).",
    ["S-bend toeside", "Rotation C7", "Réception"],
    ["s-bend-unhooked", "toe-side-riding"]
  ),
  f("c7-5", "C7 5", CAT.BIGAIR,
    "Module « Passes » — C7 +180°.",
    ["C7", "Prolonger", "Réception"],
    ["c7"]
  ),
  f("c10", "C10", CAT.BIGAIR,
    "Module « Passes » — Évolution C7 / S-bend toeside avancé.",
    ["C7 5", "Rotation supérieure", "Réception"],
    ["c7-5"]
  ),
  f("g-spot", "G-Spot", CAT.BIGAIR,
    "Module « Passes » — Toeside backmobe nommé.",
    ["Toeside backroll", "Pass mobe", "Réception"],
    ["toeside-backroll", "back-mobe"]
  ),
  f("blind-pete", "Blind Pete", CAT.BIGAIR,
    "Module « Avancé » — Variante toeside / blind liée au Pete Rose.",
    ["Pete Rose ou G-Spot", "Sortie blind", "Stabiliser"],
    ["pete-rose", "blind-judge"]
  ),
  f("dum-dum", "Dum Dum", CAT.BIGAIR,
    "Module « Avancé » — Toeside slim / tootsie family (liste PKRA).",
    ["Toeside slim setup", "Pass Dum Dum", "Réception"],
    ["slim-chance", "toeside-frontroll"]
  ),
  f("dum-dum-5", "Dum Dum 5", CAT.BIGAIR,
    "Module « Avancé » — Dum Dum +180°.",
    ["Dum Dum", "Prolonger", "Réception"],
    ["dum-dum"]
  ),
  f("tootsie-roll-pass", "Tootsie roll (pass)", CAT.BIGAIR,
    "Module « Passes » — Toeside frontroll + backside handle pass (kitingsheep / comps).",
  ...
  f("bottom-turn", "Bottom turn", CAT.WAVE,
    "Module « Virages » — Virage bas de vague pour générer de la vitesse — base du surfkite.",
  ...
  f("strapless-riding", "Strapless riding", CAT.WAVE,
    "Module « Bases » — Naviguer en surfboard sans footstraps.",
  ...
  f("strapless-air", "Strapless air", CAT.WAVE,
    "Module « Freestyle » — Saut strapless avec board control (souvent grab).",
  ...
  f("strapless-freestyle", "Strapless freestyle (combo)", CAT.WAVE,
    "Module « Freestyle » — Enchaînement shove-it, backroll, airs en strapless.",
  ...
  f("water-start-foil", "Water start foil", CAT.FOIL,
    "Module « Premiers vols » — Démarrer et faire décoller le foil.",
  ...
  f("light-wind-freestyle-foil", "Light wind freestyle foil", CAT.FOIL,
    "Module « Freestyle » — Tricks freestyle en foil par vent faible.",
